          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <div class="col-md-3">
                 ...
                 <select class="form-control" id="country" name="color" required="Không được để trống">
                   
                    <option <?php if ($record->color == "Xanh"): ?>
                           selected
                         <?php endif ?> value="Xanh">Xanh</option>
                     <option <?php if ($record->color == "Đỏ"): ?>
                           selected
                         <?php endif ?> value="Đỏ">Đỏ</option>
                      <option <?php if ($record->color == "Tím"): ?>
                           selected
                         <?php endif ?> value="Tím">Tím</option>
                       <option  <?php if ($record->color == "Vàng"): ?>
                           selected
                         <?php endif ?> value="Vàng">Vàng</option>
                        <option <?php if ($record->color == "Nâu"): ?>
                           selected
                         <?php endif ?> value="Nâu">Nâu</option>
                         <option <?php if ($record->color == "Đen"): ?>
                           selected
                         <?php endif ?> value="Đen">Đen</option>
                         <option <?php if ($record->color == "Trắng"): ?>
                           selected
                         <?php endif ?> value="Trắng">Trắng</option>
                 </select>
               </div>
             </div>
          </div>
      ...
      <option <?php if ($record->madein == "Nhật bản"): ?>
              ...
              <div class="col-md-3">
                 ...
                 <select class="form-control" id="country" name="size" required="Không được để trống">
                    <option <?php if ($record->size == "L"): ?>
                           selected
                         <?php endif ?> value="L">L</option>
                     <option <?php if ($record->size == "XL"): ?>
                           selected
                         <?php endif ?> value="XL">XL</option>
                      <option <?php if ($record->size == "XXL"): ?>
                           selected
                         <?php endif ?> value="XXL">XXL</option>
                       <option  <?php if ($record->size == "M"): ?>
                           selected
                         <?php endif ?> value="M">M</option>
                        <option <?php if ($record->size == "S"): ?>
                           selected
                         <?php endif ?> value="S">S</option>
                         <option <?php if ($record->size == "XS"): ?>
                           selected
                         <?php endif ?> value="XS">XS</option>
                         <option <?php if ($record->size == "XXS"): ?>
                           selected
                         <?php endif ?> value="XXS">XXS</option>
                 </select>
               </div>
             </div>
          </div>
