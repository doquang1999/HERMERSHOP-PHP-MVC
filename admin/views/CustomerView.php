...
<div class="container-fluid">
 ...
 echo $rows->phone;
     ?></td>
        ...
        <td style="text-align: center;"><a href="customerss/<?php echo $rows->id; ?>.html"><p data-placement="top" data-toggle="tooltip" title="Edit"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="fa fa-edit"></span></button></p></a></td>
