...
<div class="color" style="margin-top:15px;">
    ...
    color: white;" href="search/size=L.html">L</a>  
                    </li> 
                    <?php 
                elseif($key!="L"):
                     ?>
                  <li>
                    ...
                    <?php endif ?>
                       ...
                       <li>
                        <a style="background: #ba933e;
    color: white;" href="search/size=XL.html">XL</a>  
                    </li> 
                    <?php 
                elseif($key!="XL"):
                     ?>
                  <li>
                    ...
                    <?php endif ?>
                      ...
                      <?php if ($key=="XXL"): ?>
                       <li>
                        <a style="background: #ba933e;
    color: white;" href="search/size=XXL.html">XXL</a>  
                    </li> 
                    <?php 
                elseif($key!="XXL"):
                     ?>
                  <li>
                    ...
                    <?php endif ?>
                     ...
                     <?php if ($key=="M"): ?>
                       <li>
                        <a style="background: #ba933e;
    color: white;" href="search/size=M.html">M</a>  
                    </li> 
                    <?php 
                elseif($key!="M"):
                     ?>
                  <li>
                    ...
                    <?php endif ?>
                     ...
                     <?php if ($key=="S"): ?>
                       <li>
                        <a style="background: #ba933e;
    color: white;" href="search/size=S.html">S</a>  
                    </li> 
                    <?php 
                elseif($key!="S"):
                     ?>
                  <li>
                    ...
                    <?php endif ?>
                      ...
                      <?php if ($key=="XS"): ?>
                       <li>
                        <a style="background: #ba933e;
    color: white;" href="search/size=XS.html">XS</a>  
                    </li> 
                    <?php 
                elseif($key!="XS"):
                     ?>
                  <li>
                    ...
                    <?php endif ?>
                      ...
                      <?php if ($key=="XXS"): ?>
                       <li>
                        <a style="background: #ba933e;
    color: white;" href="search/size=XXS.html">XXS</a>  
                    </li> 
                    <?php 
                elseif($key!="XXS"):
                     ?>
