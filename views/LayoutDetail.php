       ...
       <!-- header top -->
        <div class="header-top">
          ...
          <div class="social" style="margin-top: 10px;">
           ...
           <a href="https://www.facebook.com/Arceus99/">
           ...
           <div class="icon-social">
            ...
            <div style="padding-left: 20px;" class="login">
              <?php if (isset($_SESSION['customer_name'])):
               ?>
            <a href="update/<?php echo $_SESSION['customer_id']; ?>.html"><img style="width: 25px;" src="assets/frontend/images/user.png">&nbsp;&nbsp;&nbsp;</a><a id="gachcheo" href="">|</a>
                ...
                .menu-top ul li a:hover
{
  color: #ba933e;
          ...
          <!-- logo -->
          <div class="logo">
            <a href="home.html"><img src="assets/frontend/images/logo.png" alt=""></a>
          </div>
          <!-- /logo -->
                     <!-- menu-top -->
