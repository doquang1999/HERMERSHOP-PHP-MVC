    	...
    	<div class="col-md-9 col-xs-12">
    		<div class="detail-post">
    			...
    			<div class="link-lien-quan">
    				...
    				<a style="text-decoration:none;" href="products/detail/<?php echo $rowsssss->id; ?>/<?php echo Unicode::removeUnicode($rowsssss->name); ?>.html"><i class="fa fa-angle-double-right"></i> <?php 
    				echo $rowsssss->name;
    				 ?></a><br>
