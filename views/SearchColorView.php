...
<div style="height: 180px;" class="item_search-box3">
                    <a class="title-left" style="color: #ba933e;">MÀU SẮC</a>
...
<div class="color" style="margin-top:15px;">
    ...
    color: white;" href="search/color=Xanh.html">Xanh</a>  
                    </li> 
                    <?php 
                elseif($key!="Xanh"):
                     ?>
                  <li>
                        <a href="search/color=Xanh.html">Xanh</a>  
                    </li>
                    <?php endif ?>
                    ...
                    <?php if ($key=="Đỏ"): ?>
                       <li>
                        <a style="background: #ba933e;
    color: white;" href="search/color=Đỏ.html">Đỏ</a>  
                    </li> 
                    <?php 
                elseif($key!="Đỏ"):
                     ?>
                  <li>
                        <a href="search/color=Đỏ.html">Đỏ</a>  
                    </li>
                    <?php endif ?>
                     ...
                     <?php if ($key=="Tím"): ?>
                       <li>
                        <a style="background: #ba933e;
    color: white;" href="search/color=Tím.html">Tím</a>  
                    </li> 
                    <?php 
                elseif($key!="Tím"):
                     ?>
                  <li>
                        <a href="search/color=Tím.html">Tím</a>  
                    </li>
                    <?php endif ?>
                     ...
                     <?php if ($key=="Vàng"): ?>
                       <li>
                        <a style="background: #ba933e;
    color: white;" href="search/color=Vàng.html">Vàng</a>  
                    </li> 
                    <?php 
                elseif($key!="Vàng"):
                     ?>
                  <li>
                        <a href="search/color=Vàng.html">Vàng</a>  
                    </li>
                    <?php endif ?>
                     ...
                     <?php if ($key=="Nâu"): ?>
                       <li>
                        <a style="background: #ba933e;
    color: white;" href="search/color=Nâu.html">Nâu</a>  
                    </li> 
                    <?php 
                elseif($key!="Nâu"):
                     ?>
                  <li>
                        <a href="search/color=Nâu.html">Nâu</a>  
                    </li>
                    <?php endif ?>
                     ...
                     <?php if ($key=="Đen"): ?>
                       <li>
                        <a style="background: #ba933e;
    color: white;" href="search/color=Đen.html">Đen</a>  
                    </li> 
                    <?php 
                elseif($key!="Đen"):
                     ?>
                  <li>
                        <a href="search/color=Đen.html">Đen</a>  
                    </li>
                    <?php endif ?>
                     ...
                     <?php if ($key=="Trắng"): ?>
                       <li>
                        <a style="background: #ba933e;
    color: white;" href="search/color=Trắng.html">Trắng</a>  
                    </li> 
                    <?php 
                elseif($key!="Trắng"):
                     ?>
                  <li>
                        <a href="search/color=Trắng.html">Trắng</a>  
                    </li>
                    <?php endif ?>
