...
<ol class="breadcrumb">
  ...
  <li class="breadcrumb-item"><a href="home.html">Trang chủ</a></li>
   <li class="breadcrumb-item"><a href="products/subcategory/<?php echo $categories->id ?>/<?php     echo $categories->name; ?>.html">
                            <?php    
	...
	function resetBorder(){
		...
		document.getElementById("img3").removeAttribute("style");
          ...
          <div class="right-top-detail-product">
          	 <div class="detail-product-title" style="color:white;">
          	<?php 
            echo $record->name;
             ?>
          	 </div>
          	 <div class="detail-product-desc" style="color:white;">
            ...
            echo $record->shortdescription;
             ?>
                ...
                <div class="characteristic" style="color:white;">
               <ul>
                  <li>
                    <?php 
             ...
             ?>
          	 ...
          	 <div class="product-price-before">
                ...
                <?php if ($record->discount > 0): ?>
                    <span style="margin-left: 10px;color:white;" class="price-before1"><?php 
          	 ...
          	 <div class="color-product-detail" style="color: white;">
          	 	Màu sắc: <strong>&nbsp;&nbsp;<?php 
                echo $record->color;
                 ?></strong>
          	 </div>
  ...
  <form action="index.php?controller=cart&action=create1&id=<?php echo $record->id; ?>" method="post">
             <div class="number">
             	      <div class="soluong" style="color: white;">
             	      	Số lượng : 
             	      </div>
                    ...
                    <style type="text/css">
                        ...
                        .btn-number
                        {
                            margin-top: -5px;margin-left: 20px;color: white;font-size: 16px;border-radius: 0px;width: 136px;height: 46px;
                            border: 0px;
                            background:black;
                        }
                    </style>
             ...
             <div style="margin-top:30px;font-family: 'Quicksand', sans-serif;" class="rating">
                 <p><strong style="font-size: 12px;color: white;">RATING : </strong>&nbsp;&nbsp;&nbsp;<i style="font-size:20px;color: #d27474" class="fa fa-heart"></i>&nbsp;<span style="font-size:16px;color: white;"> + <?php echo $this->modelGetStar($record->id); ?> cho sản phẩm này ^^</span></p>
             </div>


             <div class="share">
             	 <p class="share-title" style="color: white;">SHARE : </p>
		   ...
		   $('#slideToggle1').click(function(){
              ...
              <div class="bottom-detail">
                <div class="desc-detail">
                	<h2 style="color: white;">MÔ TẢ SẢN PHẨM</h2>
              	...
              	<div  id="img-content" class="content-detail">
              	 ...
              	 <div class="content-desc-bottom-detail" style="margin-top: 50px;">
    ...
    <div class="hot-detail-product">
      			<div style="font-family: 'Dancing Script';color: white;" class="hot-detail-product-title">
      				Sản phẩm nổi bật
      			</div>
    ...
    <div class="item">
          <div style="width: 98%;" class="content-product-detail-bottom">
                        ...
                        <div class="hot-product-title-detail">
                           <a style="color: white;" href="products/detail/<?php echo $hotrows->id; ?>/<?php echo Unicode::removeUnicode($hotrows->name); ?>.html"><?php 
                           echo $hotrows->name;
                            ?></a>
                        </div>
                        <div class="price-hot-product-detail">
                        <span class="price-detail-hot-before" style="color: white;"><?php 
      ...
      <?php endforeach ?>
          ...
          <div class="branches">
          	 <div class="slide">
          	 	<img id="img-show1" src="assets/frontend/branches/branches1.png" alt="">
             <img id="img-show2" src="assets/frontend/branches/branches2.png" alt="">
       		<img id="img-show3" src="assets/frontend/branches/branches3.png" alt="">
       			<img id="img-show4" src="assets/frontend/branches/branches4.png" alt="">
       		<img id="img-show5" src="assets/frontend/branches/branches5.png" alt="">
          	 </div>
          </div>
