...
try {
    ...
    //Recipients
    $mail->setFrom('conlondat6@gmail.com', 'Hermer - Men Fashion');
    $mail->addAddress($email);     //Add a recipient


    //Content
    $mail->isHTML(true);                                  //Set email format to HTML
    $mail->Subject = 'Xác nhận email - Thời trang Hermer';
    $mail->Body    = "Cảm ơn bạn đã đăng ký tài khoản !!!<br>
    Nhấp vào liên kết bên dưới để xác minh địa chỉ email !!!<br>
    <a href='http://localhost/FE24-Đỗ-Vinh-Quang-GD/index.php?controller=account&action=check_verify&email=$email&v_code=$v_code'>Xác nhận email</a>";
    ...
    public static function sendMail1($name,$email)
{
   require 'vendor/autoload.php';
...
$mail->addEmbeddedImage('assets/frontend/images/facebook_cover_photo_1.png', 'logo_p2t');
    ...
    //Content
    $mail->isHTML(true);                                  //Set email format to HTML
    $mail->Subject = 'Hermer - Men Fashion';
    $mail->Body    = "
<html>
<head>
<title></title>
...
<span style='font-family:Quicksand, sans-serif; font-size:14px;color:black;'>Cảm ơn bạn <strong>$name</strong> đã đặt hàng tại <strong>HERMER</strong> !!! Chúc quý khách một ngày tốt lành nhất !!!</span><br>  
